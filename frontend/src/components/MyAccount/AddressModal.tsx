import { updateUserProfile } from "@/service/user/UserProfileServices";
import React, { useEffect, useState } from "react";
import { showToast } from "../Common/ShowToaster";

const AddressModal = ({ address,phone,nameForOrder ,isOpen, closeModal }) => {


  const [localAddress, setLocalAddress] = useState(address || "");
  const [localPhone, setLocalPhone] = useState(phone || "");
  const [localNameForOrder, setLocalNameForOrder] = useState(nameForOrder || "");
  useEffect(() => {
  ...
  nameForOrder: localNameForOrder,
  phone: localPhone,
              ...
              <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                <div className="w-full">
                  ...
                  <input
                    type="text"
                    name="name"
                    value={localNameForOrder}
                     onChange={(e) => setLocalNameForOrder(e.target.value)}
