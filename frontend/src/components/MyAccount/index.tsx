...
import { fetchUserProfile, updateUserFullname, updateUserProfile } from "@/service/user/UserProfileServices";
import { showToast } from "../Common/ShowToaster";
import { selectCurrentUser } from "@/redux/features/user-slice";
import { useSelector } from "react-redux";
import { changepassword } from "@/service/user/AuthServices";
...
const MyAccount = () => {
  ...
  fetchUserProfile()
    .then((data) => {
      setProfile(data);
      setFullName(data.fullName); // lấy trực tiếp
      setNameForOrder(data.profile.nameForOrder);
      setPhone(data.profile.phone);
      setAddress(data.profile.address);
    })
    .catch((err) => showToast("Lỗi lấy thông tin người dùng","warning"));
}, []);
  ...
  setErrorConfirm(""); // Xóa lỗi nếu khớp
}
  try {
    var token = localStorage.getItem("token")
    await changepassword(token,currentPassword, newPassword, comfirmPassword);
    showToast("Cập nhật thành công!","success");
  ...
  return (
    <>
      ...
      <section className="overflow-hidden py-20 bg-gray-2">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div className="xl:max-w-[370px] w-full bg-white rounded-xl shadow-1">
              <div className="flex xl:flex-col">
                <div className="hidden lg:flex flex-wrap items-center gap-5 py-6 px-4 sm:px-7.5 xl:px-9 border-r xl:border-r-0 xl:border-b border-gray-3">
                  ...
                  <div>
                    <p className="font-medium text-dark mb-0.5 text-2xl">
                      {profile.email}
                    </p>
                    <p className="font-medium text-gray-400 mb-0.5 text-base">
                     {fullName}
                    </p>
          ...
          {/* <!-- addresses tab content start --> */}
            ...
            >
              <div className="w-full mx-auto overflow-x-auto bg-white shadow-1 rounded-xl">
      ...
      <p className="text-custom-sm mt-5 mb-9">
        Đây sẽ là cách tên của bạn được hiển thị trong phần tài khoản và trong phần review
      </p>
  ...
  <input
    ...
    onChange={(e) => {
      ...
      setErrorConfirm(""); // Xóa lỗi khi người dùng bắt đầu gõ lại
    }}
    className="rounded-md border border-gray-3 bg-gray-1 w-full py-2.5 px-5 outline-none focus:ring-2 focus:ring-blue/20"
  />
  ...
  {errorConfirm && (
    <p className="text-red-500 text-sm mt-1">{errorConfirm}</p>
      ...
      <AddressModal nameForOrder={nameForOrder} phone={phone} address={address}  isOpen={addressModal} closeModal={closeAddressModal} />
    </>
  );
};
