...
import { register } from "@/service/user/AuthServices";
...
const Signup = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      router.push("/signin"); // hoặc trang chính
    } catch (err) {
              ...
              <form onSubmit={handleRegister} >
                <div className="mb-5">
                  <label htmlFor="name" className="block mb-2.5">
                    Họ tên đầy đủ<span className="text-red">*</span>
                  </label>
