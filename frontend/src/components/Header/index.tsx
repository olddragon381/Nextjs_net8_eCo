...
import { getMenuUserData, menuData  } from "./menuData";
...
import { fetch7Categories } from "@/service/category/CategoryService";
...
const Header = () => {
  ...
  const menuUserData = user ? getMenuUserData(user.fullname) : [];
...
const [page, setPage] = useState(1);
  ...
  useEffect(() => {
  fetch7Categories().then((categories: Category[]) => {
  ...
  const userOptions = [
    { label: "Thông tin tài khoản", value: "0" },
    { label: "Đơn hàng của tôi", value: "1" },
    { label: "Đăng xuất", value: "2" },
  ]
              ...
              <div className="flex items-center gap-5">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <ul >
                       <span className="text-2xs text-dark-4 uppercase">
                      Tài khoản 
                    </span>
{menuUserData.map((menu, i) =>
                    menu.submenu ? (
                      ...
                      >
                        ...
                        >
                          <span className="pt-0.5">{menu.title}</span>
                        </Link>
                      </li>
                    )
                  )}           
          ...
          <Link href="/signin" className="font-medium text-custom-sm text-dark">
            Đăng nhập
          </Link>
          </div>
